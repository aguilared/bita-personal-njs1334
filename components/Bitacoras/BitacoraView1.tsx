...
const BitacoraView1 = (props: any): JSX.Element => {
  ...
  useEffect(
    function () {
      setLoading(true);
      getBitacora(bitacoraSelected).then((resp) => {
  ...
  const { data, error } = useSWR(
    `${process.env.NEXT_PUBLIC_API_URL}/bitacora/events/${bitacoraSelected}`,
    fetcher
  );
      ...
      <div className="bg-white shadow-lg rounded">
        <div className="flex justify-between p-1">
          <div>
            ...
            <h3 className="text-2xl tahoma font-extrabold tracking-widest text-gray-500">
              Bitacora Personal # {bitacoraSelected}, Events:{totalEvents}
            </h3>
          </div>
          <div className="p-2">
            <ul className="flex">
...
BitacoraView1.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(BitacoraView1);
